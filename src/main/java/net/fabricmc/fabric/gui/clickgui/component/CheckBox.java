...
extends Component {
    ...
    public void drawScreen(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (this.setting.isEnabled()) {
            ...
            ClientMain.fontRenderer.drawString(matrices, ClientMain.mc.textRenderer, this.setting.getName(), this.x + (float)this.parent.x + 445.0f, this.y + 8.0f, -1);
            ...
            ClientMain.fontRenderer.drawString(matrices, ClientMain.mc.textRenderer, this.setting.getName(), this.x + (float)this.parent.x + 445.0f, this.y + 8.0f, Theme.SLIDER_SETTING_BG.getRGB());
